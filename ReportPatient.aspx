<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="ReportPatient.aspx.cs" Inherits="MedHealthSolutions.ReportPatient" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="BodyContent" >
    ...
    <script type="text/javascript" language="javascript">
        ...
        function getReport() {
            ...
            $.ajax({
                type: "POST",
                url: "ReportPatient.aspx/getReport",
                data: "{" + params + "}",
...
</form><form id='fDwn' method='post' action='ReportPatient.aspx'><input type='hidden' name='param' id='param' />
</asp:Content>
