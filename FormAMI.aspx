<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="FormAMI.aspx.cs" Inherits="MedHealthSolutions.FormAMI" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="BodyContent" >
    <style >
        ...
        #cssmenu ul li a {
            border-bottom-color: #fbbd00 !important;
        }
    </style>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function showInitializeLists(ar) {
            ...
            $(".Exercise").html(ar[8])
            $(".CalledBy").html(ar[9])
            $(".ProceduresDuringHospitalization").html(ar[10])
            $(".ExerciseFrequency").html(ar[11])
        }
    </script>
<table id="rpt_tbl" class="main_tbl">
    <tr>
        <td class="frm_td s31 pad10">
            <b class="btn3 margin3" id='bChange' onclick="NewForm(0)">New AMI Form</b>  
            <br />
            <br /> 
...
<div id="entry_form" class="frm_tbl hide">
    ...
    <table id="gridDetail" class="frm_tbl2" style="background-color:#efefef">
        ...
        <tr id="rowReviewBetaBlockerAceStatinASA" d="ReviewBetaBlockerAceStatinASA" t="t"><th>Review Beta Blocker/Ace/Statin/ASA</th><td class="fu1 s2">&nbsp;</td><td class="fu2 s2">&nbsp;</td><td class="fu3 s2">&nbsp;</td><td class="fu4 s2">&nbsp;</td><td class="fu5 s2">&nbsp;</td><td class="fu6 s2">&nbsp;</td><td class="fu7 s2">&nbsp;</td><td class="fu8 s2">&nbsp;</td></tr>
        ...
        <tr id="rowProceduresDuringHospitalization" d="ProceduresDuringHospitalization" t="d"><th>Procedures During Hospitalization</th><td class="fu1 s2">&nbsp;</td><td class="fu2 s2">&nbsp;</td><td class="fu3 s2">&nbsp;</td><td class="fu4 s2">&nbsp;</td><td class="fu5 s2">&nbsp;</td><td class="fu6 s2">&nbsp;</td><td class="fu7 s2">&nbsp;</td><td class="fu8 s2">&nbsp;</td></tr>
...
<table id="controls" class="hide">
    ...
    <tr><td>
        <input value="" class="s61" maxlength=1000 placeholder="Review Beta Blocker/Ace/Statin/ASA" />
    </td></tr>
    <tr><td>
    ...
    <tr><td>
        <select class="s7 ProceduresDuringHospitalization" data-placeholder="Procedures During Hospitalization"></select>
	</td></tr>
    <tr><td>
