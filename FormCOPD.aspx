<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="FormCOPD.aspx.cs" Inherits="MedHealthSolutions.FormCOPD" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="BodyContent" >
    <style >
        .btn3, .rpt_tbl th, .frm_tbl th, .default_color, #cssmenu {
            background-color: #4270c1 !important;            
        }
        #cssmenu ul li a {
            border-bottom-color: #4270c1 !important;
        }
    </style>
...
<table id="rpt_tbl" class="main_tbl">
    <tr>
        <td class="frm_td s31 pad10">
            <b class="btn3 margin3" id='bChange' onclick="NewForm(0)">New COPD Form</b>  
            <br />
            <br /> 
...
<div id="entry_form" class="frm_tbl hide">
    ...
    <table id="gridHeader">
        <tr><th class="s6" style="color:#007dbb;background-color:#fff;">Confirmed F/U with PCP and Pulmonologist</th><th class="s2 m_hnd" d="1" id="H1">24 Hrs</th><th class="s2 m_hnd" d="2" id="H2">48 Hrs</th><th class="s2 m_hnd" d="3" id="H3">72 Hrs</th><th class="s2 m_hnd" d="4" id="H4">5 Days</th><th class="s2 m_hnd" d="5" id="H5">7 Days</th><th class="s2 m_hnd" d="6" id="H6">14 Days</th><th class="s2 m_hnd" d="7" id="H7">21 Days</th><th class="s2 m_hnd" d="8" id="H8">28 Days</th></tr>
    </table>
    </div><div style="padding-top:161px;width:1339px;">
    <table id="gridDetail" class="frm_tbl2" style="background-color:#efefef">
        <tr id="rowProvider" d="Provider" t="d"><th class="s6">Pulmonologist Name</th><td class="fu1 s2">&nbsp;</td><td class="fu2 s2">&nbsp;</td><td class="fu3 s2">&nbsp;</td><td class="fu4 s2">&nbsp;</td><td class="fu5 s2">&nbsp;</td><td class="fu6 s2">&nbsp;</td><td class="fu7 s2">&nbsp;</td><td class="fu8 s2">&nbsp;</td></tr>
...
<table id="controls" class="hide">
	<tr><td>
        <select class="s7 choosen-control Provider" data-placeholder="Pulmonologist Name"></select>
	</td></tr>
    <tr><td>
